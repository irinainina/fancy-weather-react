...
const clearNight = `
<svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 30.8 42.5" style="enable-background:new 0 0 30.8 42.5;" xml:space="preserve" height="50%" width="100%">
...
`;
 ...
 const fog = `
<svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 45.1 47.6" style="enable-background:new 0 0 45.1 47.6;" xml:space="preserve" height="65%" width="100%">
            <style type="text/css">
...
function weatherIcons(id, icon) {  
  const weatherIconsArr = [clearDay, clearNight, cloudy, fog, partlyCloudyDay, partlyCloudyNight, rain, sleet, snow, wind];
  let iconIndex;
  if(id.toString()[0] === '2' || id.toString()[0] === '3' || id.toString()[0] === '5') {
    iconIndex = 6;
  } else if(id.toString()[0] === '6') {
    iconIndex = 8;
  } else if(id.toString()[0] === '7') {
    iconIndex = 3;
  } else if(id === 800 && icon[2] === 'd') {
    iconIndex = 0;
  } else if(id === 800 && icon[2] === 'n') {
    iconIndex = 1;
  } else if((id === 801 || id === 802) && icon[2] === 'd') {
    iconIndex = 4;
  } else if((id === 801 || id === 802) && icon[2] === 'n') {
    iconIndex = 5;
  ...
  return weatherIconsArr[iconIndex];
}

export {clearDay, clearNight, cloudy, fog, partlyCloudyDay, partlyCloudyNight, rain, sleet, snow, wind, weatherIcons};